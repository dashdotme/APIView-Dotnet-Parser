...
namespace APIView.DotnetParser.Analysis
{
    internal class Analyzer : SymbolVisitor
    {
        public List<CodeDiagnostic> Results { get; } = new List<CodeDiagnostic>();

        private readonly List<Azure.ClientSdk.Analyzers.SymbolAnalyzerBase> _analyzers = new List<Azure.ClientSdk.Analyzers.SymbolAnalyzerBase>();
